 ...
 *  Output Format : 
 *      For each test case, print the elements of the array/list in the desired 
 ...
 *      All the zeros have been pushed towards the end of the array/list. Another 
 *      important fact is that the order of the non-zero elements have been 
