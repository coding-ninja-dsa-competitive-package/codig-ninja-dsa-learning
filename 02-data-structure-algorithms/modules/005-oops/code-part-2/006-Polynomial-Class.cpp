 ...
 *  
 *  Properties :
 *  1.  An integer (lets say A) which holds the coefficient and degrees. Use array 
 *      indices as degree and A[i] as coefficient of ith degree.
 *  2.  An integer holding total size of array A.
 * 
 *  Functions :
 *  1.  Default constructor
 *  2.  Copy constructor
 *  3.  setCoefficient - This function sets coefficient for a particular degree 
 *          value. If the given degree is greater than the current capacity of 
 *          polynomial, increase the capacity accordingly and add then set the 
 *          required coefficient. If the degree is within limits, then previous 
 *          coefficient value is replaced by given coefficient value
 ...
 *  8.  print() - Prints all the terms (only terms with non zero coefficients are 
