 ...
 *  
 *  Input Format:
 *      The first list of input contains an integer 't' denoting the number of 
 *      test cases/queries to be run.
 ...
 *  Output Format:
 *      For each test case/query, the only line of output prints the order in 
