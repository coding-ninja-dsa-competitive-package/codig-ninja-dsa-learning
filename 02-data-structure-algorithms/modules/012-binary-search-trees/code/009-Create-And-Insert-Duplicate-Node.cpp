 ...
 *      the node data.
 *  Output Format :
 *      The updated tree will be printed in a level order fashion where each 
 *      level will be printed on a new line. Elements on every level will be 
 *      printed in a linear fashion. A single space will separate them.
 * 
 *  Constraints :
 *      1 <= N <= 10^5
