 ...
 *      total number of people standing in queue or the size of the array of 
 *      priorities. Let us denote it with the symbol N.
 *      The following line contains N space separated integers, that denote the 
 *      value of the elements of the array of priorities.
 *      The following contains an integer, that denotes the value of index of 
 *      your priority. Let us denote it with symbol k.
 *  Output Format :
 *      The first and only line of output contains the time required for you to 
 *      get the ticket.
 * 
 *  Constraints:
 *      
 ...
 *      person with higher priority than you. So you'll get the ticket. Time : 2 secs.
 * 
 *  Sample Input 2 :
 *      5
 *      2 3 2 2 4   
