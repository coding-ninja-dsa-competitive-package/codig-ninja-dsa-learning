 ...
 *      contains numbers from 0 to (N - 2). Each number is present at 
 *      least once. That is, if N = 5, the array/list constitutes values 
 *      ranging from 0 to 3, and among these, there is a single integer 
 *      value that is present twice. You need to find and return that 
