 ...
 *      sides of triangle. If no such triangle is possible, then print -1. Print the sides 
 *      in increasing order of their lengths.
 *  Constraints
 *      1 =< N <= 10^5 
 *      1 <= A[i] <= 10^9
 *  
 ...
 *      -1 
 *  Explaination
 *      In the First Sample case, the elements that form a triangle with maximum perimeter 
 *      is 1,3,3. In the Second Sample case, the elements that can form a triangle are 
 *      degenerate, so, we printed -1.
 */
